...
<body>
	<div id="wrapper">
		...
		<form name="myForm" id="myForm" method="post" action="myAction">
			<input type="hidden" name="action" value="edu.action.evaluation.EvaluationFormAction">
			<div id="page-wrapper">
				<div class="row">
					<div class="col-lg-12">
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-heading">Choose time-slot for Evaluation</div>
									...
									<table class="table table-striped table-bordered table-hover" id="dataTables-example">
										...
										<tbody>
											...
											<tr class="even gradeC">
												<td><input type="radio" name="presentation" value="<%=keyValue.getKey()%>,<%=keyValue.getValue()%>" /></td>
